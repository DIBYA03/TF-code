...
func main() {
	...
	r.Get("/", awsAuthCLICon.GetLocalAWSAuthCLI)
	r.Get("/aws/signin", awsAuthCLICon.GetLocalAWSConsoleSignIn)
	r.Get("/aws", awsAuthCLICon.GetLocalAWSAuthCLI)
	r.Post("/aws", awsAuthCLICon.PostLocalAWSAuthCLI)
