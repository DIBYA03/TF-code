...
type BusinessPendingTransactionLog struct {
	*BusinessPendingTransactionCreate
...
func (store pendingTxnStore) Log(t *BusinessPendingTransactionCreate, c *BusinessCardTransactionCreate, h *BusinessHoldTransactionCreate) error {
	...
	txn := BusinessPendingTransactionLog{
		BusinessPendingTransactionCreate: t,
		CardDetails:                      c,
		HoldDetails:                      h,
	}
