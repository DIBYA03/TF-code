...
import (
	...
	_ "github.com/lib/pq" // init only
)

//DBWrite use to write to DB
var DBWrite *sqlx.DB

// DBRead use to read from DB
var DBRead *sqlx.DB
...
func init() {
	...
	var user = os.Getenv("CSP_DB_USER")
	var password = os.Getenv("CSP_DB_PASSWD")
	var dbName = os.Getenv("CSP_DB_NAME")

	// Set up write connection
	var writeEndpoint = os.Getenv("CSP_DB_WRITE_URL")
	var writePort = os.Getenv("CSP_DB_WRITE_PORT")
	var ssl = os.Getenv("DB_SSL_MODE")
	if ssl == "" {
		ssl = "require"
	}
	...
	var readEndpoint = os.Getenv("CSP_DB_READ_URL")
	var readPort = os.Getenv("CSP_DB_READ_PORT")
