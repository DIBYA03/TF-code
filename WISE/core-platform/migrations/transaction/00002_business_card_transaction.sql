-- +goose Up
CREATE TABLE business_card_transaction ( 
	...
	auth_amount                 double PRECISION NOT NULL, 
...
CREATE INDEX business_card_transaction_transaction_id_fk ON business_card_transaction(transaction_id);

-- +goose Down
DROP INDEX business_card_transaction_transaction_id_fk;
DROP TABLE business_card_transaction;
