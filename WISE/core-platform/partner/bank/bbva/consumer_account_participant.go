...
func (s *consumerAccountService) partnerParticipantRequestFrom(p bank.AccountParticipantRequest) (*ParticipantRequest, error) {
	if s.consumer.KYCStatus != bank.KYCStatusApproved {
...
func (s *consumerAccountService) partnerAllParticipantsFromConsumer(preq bank.CreateConsumerBankAccountRequest) ([]ParticipantRequest, error) {
	holder, err := s.partnerParticipantRequestFrom(
		bank.AccountParticipantRequest{
			ConsumerID: preq.AccountHolderID,
			Role:       bank.AccountRoleHolder,
		},
	)
	if err != nil {
		return nil, err
...
func (s *consumerAccountService) GetParticipants(id bank.AccountBankID) ([]bank.AccountParticipantResponse, error) {
...
func (s *consumerAccountService) AddParticipants(id bank.AccountBankID, p []bank.AccountParticipantRequest) ([]bank.AccountParticipantResponse, error) {
...
func (s *consumerAccountService) AddParticipant(id bank.AccountBankID, p bank.AccountParticipantRequest) (*bank.AccountParticipantResponse, error) {
	c, err := data.NewConsumerService(s.request, bank.ProviderNameBBVA).GetByConsumerID(p.ConsumerID)
	if err != nil {
		return nil, err
	}
...
func (s *consumerAccountService) RemoveParticipant(aid bank.AccountBankID, cid bank.ConsumerID) error {
