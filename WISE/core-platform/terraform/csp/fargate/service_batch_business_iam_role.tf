resource "aws_iam_role" "batch_business_execution_role" {
  name = "${module.naming.aws_iam_role}-batch-business-execution-role"
...
resource "aws_iam_role_policy" "batch_business_review_sqs" {
  name = "${module.naming.aws_iam_policy}-review-sqs"
  role = "${aws_iam_role.batch_business_execution_role.id}"
...
resource "aws_iam_role_policy" "batch_business_s3_doc_read_write" {
...
resource "aws_iam_role_policy" "batch_business_segment_analytics_sqs" {
...
resource "aws_iam_role_policy" "batch_business_execution_role" {
