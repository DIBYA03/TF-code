resource "aws_lambda_function" "cognitoauth_pretoken_lambda" {
  ...
  filename         = "../../../cmd/lambda/cognitoauth/pretoken/lambda.zip"
  source_code_hash = "${base64sha256(file("../../../cmd/lambda/cognitoauth/pretoken/lambda.zip"))}"
  runtime          = "go1.x"
  handler          = "main"
...
resource "aws_lambda_permission" "cognitoauth_pretoken_lambda" {
  ...
  function_name = "${aws_lambda_function.cognitoauth_pretoken_lambda.function_name}"
...
resource "aws_ssm_parameter" "cognitoauth_pretoken_lambda_warmer" {
  name      = "/${var.environment}/${aws_lambda_function.lambda_warmer_lambda.function_name}/${aws_lambda_function.cognitoauth_pretoken_lambda.function_name}"
  type      = "String"
