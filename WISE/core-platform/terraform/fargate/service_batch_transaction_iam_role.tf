resource "aws_iam_role" "batch_transaction_execution_role" {
  name = "${module.naming.aws_iam_role}-batch-transaction-execution-role"
...
resource "aws_iam_role_policy" "batch_transaction_execution_role" {
  name = "${module.naming.aws_iam_policy}-default-execution"
  role = "${aws_iam_role.batch_transaction_execution_role.id}"
