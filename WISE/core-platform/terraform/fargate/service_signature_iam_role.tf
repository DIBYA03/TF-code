resource "aws_iam_role" "signature_execution_role" {
  name = "${module.naming.aws_iam_role}-signature-execution-role"
...
resource "aws_iam_role_policy" "signature_execution_role" {
  name = "${module.naming.aws_iam_policy}-default-execution"
  role = "${aws_iam_role.signature_execution_role.id}"
...
resource "aws_iam_role_policy" "signature_s3_read_write" {
