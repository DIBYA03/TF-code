resource "aws_iam_role" "segment_analytics_execution_role" {
  name = "${module.naming.aws_iam_role}-segment-analytics-execution-role"
...
resource "aws_iam_role_policy" "segment_analytics_execution_role" {
  name = "${module.naming.aws_iam_policy}-default-execution"
  role = "${aws_iam_role.segment_analytics_execution_role.id}"
